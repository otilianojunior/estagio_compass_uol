...
WHERE a.origem = 'tmdb'
  AND a.id_filme NOT IN (3111, 19610, 332562, 70881, 50512, 96724, 665, 271969, 11349, 1598, 4415, 82695, 877, 111, 982, 14462, 25736, 11027, 17529, 44264)) AS "desafio-filmes-recomendacoes"