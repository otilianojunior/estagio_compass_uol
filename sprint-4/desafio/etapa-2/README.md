...
![docker ps -a](../../evidencias/docker-ps-a.png)
...
![docker start nome_id](../../evidencias/docker-start-desafio-sprint-container.png)
...
![docker start nome_id](../../evidencias/docker-logs-desafio-sprint-container.png)
